                ...
                @forelse($dayBookings as $booking)
                    <article class="booking {{ $booking->cancelled_at?'cancelled':($booking->confirmed_at?'':'pending') }}">
                        ...
                        <div class="booking-actions">
                            ...
                            @endif
                            <a class="action-link action-edit" href="{{ route('agenda.index',['date'=>$selectedDate,'month'=>$month->format('Y-m'),'edit'=>$booking->id]) }}">Modifica prenotazione</a>
                            @if(!$booking->cancelled_at)
