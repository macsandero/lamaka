                    ...
                    <article class="booking {{ $booking->cancelled_at?'cancelled':($booking->confirmed_at?'':'pending') }}">
                        ...
                        <div class="booking-actions">
                            @if(!$booking->confirmed_at && !$booking->cancelled_at)
                                <form class="inline-action" method="post" action="{{ route('agenda.confirm',$booking) }}">@csrf<button class="action-button action-confirm" type="submit">Conferma prenotazione</button></form>
                            @endif
                            ...
                            @if(!$booking->cancelled_at)
                                <details>
                                    <summary class="cancel-summary action-cancel">Annulla prenotazione</summary>
